...
<script>
	import provinceData from '../../static/js/city-data/province.js'
	import getCity from '../../static/js/city-data/city.js';
	import getArea from '../../static/js/city-data/area.js';
	import getStreets from '../../static/js/city-data/streets.js';
	export default {
		data() {
			return {
				province: "请选择",
